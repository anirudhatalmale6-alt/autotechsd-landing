...
ICON_TICK = ('<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.6" '
             'stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">'
             '<path d="M20 6 9 17l-5-5"/></svg>')
# Trust-strip icons. These are the SOLID Font Awesome glyphs, because that is
# what his home page bar uses — I measured it on 29 Aug: three 35x35 webp files
# (star-solid, location-dot-solid, clock-solid) uploaded to his media library,
# filled #313131, the same colour as the text beside them. My first version used
# thin outline icons of my own, which is what he was looking at when he wrote
# "idk if its the color code or what / also font style / they got to match all
# this". Same family, same weight, same fill now.
ICON_BAYS = ('<svg viewBox="0 0 640 512" fill="currentColor" aria-hidden="true">'
             '<path d="M0 488V171.3c0-26.2 15.9-49.7 40.2-59.4L308.1 4.8c7.6-3.1 16.1-3.1 23.8 0'
             'L599.8 111.9c24.3 9.7 40.2 33.3 40.2 59.4V488c0 13.3-10.7 24-24 24H568c-13.3 0-24-10.7-24-24'
             'V224c0-17.7-14.3-32-32-32H128c-17.7 0-32 14.3-32 32V488c0 13.3-10.7 24-24 24H24'
             'c-13.3 0-24-10.7-24-24zm488 24l-336 0c-13.3 0-24-10.7-24-24V432H512v56c0 13.3-10.7 24-24 24z'
             'M128 400V336H512v64H128zm0-96V248c0-13.3 10.7-24 24-24H488c13.3 0 24 10.7 24 24v56H128z"/></svg>')
ICON_EST = ('<svg viewBox="0 0 384 512" fill="currentColor" aria-hidden="true">'
            '<path d="M173.8 5.5c11-7.3 25.4-7.3 36.4 0L228 17.2c6 3.9 13 5.8 20.1 5.4l21.3-1.3'
            'c13.2-.8 25.6 6.4 31.5 18.2l9.6 19.1c3.2 6.4 8.4 11.5 14.7 14.7L344.5 83'
            'c11.8 5.9 19 18.3 18.2 31.5l-1.3 21.3c-.4 7.1 1.5 14.2 5.4 20.1l11.8 17.8'
            'c7.3 11 7.3 25.4 0 36.4L366.8 227.6c-3.9 6-5.8 13-5.4 20.1l1.3 21.3'
            'c.8 13.2-6.4 25.6-18.2 31.5l-19.1 9.6c-6.4 3.2-11.5 8.4-14.7 14.7L301 343.9'
            'c-5.9 11.8-18.3 19-31.5 18.2l-21.3-1.3c-7.1-.4-14.2 1.5-20.1 5.4l-17.8 11.8'
            'c-11 7.3-25.4 7.3-36.4 0l-17.8-11.8c-6-3.9-13-5.8-20.1-5.4l-21.3 1.3'
            'c-13.2 .8-25.6-6.4-31.5-18.2l-9.6-19.1c-3.2-6.4-8.4-11.5-14.7-14.7L39.5 301'
            'c-11.8-5.9-19-18.3-18.2-31.5l1.3-21.3c.4-7.1-1.5-14.2-5.4-20.1L5.5 210.2'
            'c-7.3-11-7.3-25.4 0-36.4l11.8-17.8c3.9-6 5.8-13 5.4-20.1l-1.3-21.3'
            'c-.8-13.2 6.4-25.6 18.2-31.5l19.1-9.6C65 70.2 70.2 65 73.4 58.6L83 39.5'
            'c5.9-11.8 18.3-19 31.5-18.2l21.3 1.3c7.1 .4 14.2-1.5 20.1-5.4L173.8 5.5z'
            'M272 192a80 80 0 1 0 -160 0 80 80 0 1 0 160 0zM1.3 441.8L44.4 339.3c.2 .1 .3 .2 .4 .4'
            'l9.6 19.1c11.7 23.2 36 37.3 62 35.8l21.3-1.3c.2 0 .5 0 .7 .2l17.8 11.8'
            'c5.1 3.3 10.5 5.9 16.1 7.7l-37.6 89.3c-2.3 5.5-7.4 9.2-13.3 9.7s-11.6-2.2-14.8-7.2'
            'L74.4 455.5l-56.1 8.3c-5.7 .8-11.4-1.5-15-6.1s-4.3-10.7-2.1-16zm248 60.4L211.7 413'
            'c5.6-1.8 11-4.3 16.1-7.7l17.8-11.8c.2-.1 .4-.2 .7-.2l21.3 1.3c26 1.5 50.3-12.6 62-35.8'
            'l9.6-19.1c.1-.2 .2-.3 .4-.4l43.2 102.5c2.2 5.3 1.4 11.4-2.1 16s-9.3 6.9-15 6.1'
            'l-56.1-8.3-32.2 49.2c-3.2 5-8.9 7.7-14.8 7.2s-11-4.3-13.3-9.7z"/></svg>')
# The same glyph as the star-solid.webp already sitting in his media library.
ICON_STAR = ('<svg viewBox="0 0 576 512" fill="currentColor" aria-hidden="true">'
             '<path d="M316.9 18C311.6 7 300.4 0 288.1 0s-23.4 7-28.8 18L195 150.3 51.4 171.5'
             'c-12 1.8-22 10.2-25.7 21.7s-.7 24.2 7.9 32.7L137.8 329 113.2 474.7'
             'c-2 12 3 24.2 12.9 31.3s23 8 33.8 2.3l128.3-68.5 128.3 68.5c10.8 5.7 23.9 4.9 33.8-2.3'
             's14.9-19.3 12.9-31.3L438.5 329 542.7 225.9c8.6-8.5 11.7-21.2 7.9-32.7'
