/* Auto Tech Specialists — landing page behaviour
   No dependencies. Keep it small: everything here is progressive enhancement. */
(function () {
  'use strict';
  ...
  form.addEventListener('submit', function (e) {
    ...
    // DEMO BUILD: no backend is wired up on the staging preview. On the live
    // site this submit handler posts to the existing appointments endpoint.
